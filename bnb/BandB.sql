...
CREATE TABLE IF NOT EXISTS bookings (
  ...
  checkoutDate DATE,
  customer text,
  contactumber varchar(10),
  bookingExtras text,
  PRIMARY KEY (bookingID)
) AUTO_INCREMENT=1;
INSERT INTO `bookings` (`bookingID`,`roomname`,`checkinDate`,`checkoutDate`, `customer`) VALUES (1,"Kellie","2019-09-15","2019-09-19","Buckmaster, Gaines");
INSERT INTO `bookings` (`bookingID`,`roomname`,`checkinDate`,`checkoutDate`, `customer`) VALUES (2,"Herman","2019-09-16","2019-09-17", "Montana, Gallagher");
INSERT INTO `bookings` (`bookingID`,`roomname`,`checkinDate`,`checkoutDate`, `customer`) VALUES (3,"Kellie","2019-09-20","2019-09-21","Walker, Irene");
