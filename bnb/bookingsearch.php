...
//prepare a query and send it to the server using our search string as a wildcard on surname
    $query = "SELECT bookingID,roomname,checkinDate,checkoutDate,firstname,lastname,contactnumber,bookingExtras FROM bookings /**WHERE lastname LIKE '$sq%'**/ ORDER BY checkinDate";
